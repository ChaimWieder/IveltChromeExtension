(function(){
	...
	if(chrome.storage){
		chrome.storage.local.get(['alwaysCopyTopic', 'stickyPostButtons', 'copyAttachments', 'forceUpdateTopicMapCache', 'cachedTopicMappingExpire', 'hideUserName', 'warnOnLosingPost','backgroundSync', 'backgroundSyncPosts', 'ShowMultiNotifs', 'visualEditor'], function(items){
			...
			e.setAttribute('data-visual-editor',items.visualEditor);
